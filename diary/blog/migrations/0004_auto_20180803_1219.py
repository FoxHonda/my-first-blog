# Generated by Django 2.0.7 on 2018-08-03 09:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='status',
            field=models.CharField(blank=True, choices=[('d', 'Deleted'), ('a', 'Active'), ('h', 'Hidden'), ('b', 'Banned')], default='a', help_text='Статус поста', max_length=1),
        ),
        migrations.AlterField(
            model_name='post',
            name='tags',
